...
class Player:
    def __init__(self, speed=0.05, scale=0.15, loop=True, x=380, y=250):
        ...
        a = pyglet.resource.image('mylevel/sprites/hero/Attack (1).png', flip_x=False)
        b = pyglet.resource.image('mylevel/sprites/hero/Attack (2).png', flip_x=False)
        c = pyglet.resource.image('mylevel/sprites/hero/Attack (3).png', flip_x=False)
        d = pyglet.resource.image('mylevel/sprites/hero/Attack (4).png', flip_x=False)
        e = pyglet.resource.image('mylevel/sprites/hero/Attack (5).png', flip_x=False)
        f = pyglet.resource.image('mylevel/sprites/hero/Attack (6).png', flip_x=False)
        g = pyglet.resource.image('mylevel/sprites/hero/Attack (7).png', flip_x=False)
        h = pyglet.resource.image('mylevel/sprites/hero/Attack (8).png', flip_x=False)
        i = pyglet.resource.image('mylevel/sprites/hero/Attack (9).png', flip_x=False)
