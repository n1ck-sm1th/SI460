...
class Game:
    ...
    def __init__(self, width=800, height=600, caption="Would you like to play a game?", players=[], resizable=False):
        ...
        def on_draw():
            ...
            #Draw the platform
            pyglet.resource.image("mylevel/tiles/hl.png").blit(275, 160,height=100)
            pyglet.resource.image("mylevel/tiles/hm.png").blit(400, 160,height=100)
            pyglet.resource.image("mylevel/tiles/hr.png").blit(525, 160,height=100)
